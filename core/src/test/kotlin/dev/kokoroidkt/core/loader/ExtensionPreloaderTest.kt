...
class ExtensionPreloaderTest {
    ...
    fun `preload with empty preloaders returns empty result`() {
        val preloader = ExtensionPreloader(
            DriverPreloader(),
            AdapterPreloader(),
            PluginPreloader(),
        )
    ...
    fun `buildClassLoaders with dependency chain creates all classloaders`() {
        ...
        val driver = ExtensionDescriptor(
        ...
        val adapter = ExtensionDescriptor(
        ...
        val plugin = ExtensionDescriptor(
    ...
    fun `buildClassLoaders with diamond dependency creates all classloaders`() {
        ...
        val adapterA = ExtensionDescriptor(
        ...
        val adapterB = ExtensionDescriptor(
